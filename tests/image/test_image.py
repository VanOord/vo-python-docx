...
class DescribeImage(object):
    ...
    def it_can_construct_from_an_image_stream(self, from_stream_fixture):
        ...
        Image__init_.assert_called_once_with(blob_, filename_out, image_header_)
    ...
    @pytest.fixture
    def from_blob_fixture(self, blob_, BytesIO_, _from_stream_, stream_, image_):
    ...
    def _from_stream_(self, request, image_):
        return method_mock(request, Image, "_from_stream", return_value=image_)
