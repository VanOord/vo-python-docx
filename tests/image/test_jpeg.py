...
from docx.image.jpeg import (Exif, Jfif, Jpeg, _App0Marker, _App1Marker,
                             _JfifMarkers, _Marker, _MarkerFactory,
                             _MarkerFinder, _MarkerParser, _SofMarker)
from docx.image.tiff import Tiff

from ..unitutil.mock import (call, class_mock, initializer_mock, instance_mock,
                             method_mock)
...
class Describe_JfifMarkers(object):
    def it_can_construct_from_a_jfif_stream(self, from_stream_fixture):
        stream_, _MarkerParser_, _JfifMarkers__init_, marker_lst = from_stream_fixture
...
class Describe_App1Marker(object):
    ...
    def it_can_construct_from_non_Exif_APP1_segment(self, non_Exif_fixture):
        ...
        app1_marker = _App1Marker.from_stream(stream, marker_code, offset)
        _App1Marker__init_.assert_called_once_with(marker_code, offset, length, 72, 72)
        assert isinstance(app1_marker, _App1Marker)
    ...
    def _tiff_from_exif_segment_(self, request, tiff_):
        return method_mock(
            request, _App1Marker, "_tiff_from_exif_segment", return_value=tiff_
        )
