...
class DescribeTiff(object):
    def it_can_construct_from_a_tiff_stream(self, from_stream_fixture):
        ...
        Tiff__init_.assert_called_once_with(px_width, px_height, horz_dpi, vert_dpi)
    ...
    @pytest.fixture
    def from_stream_fixture(self, stream_, _TiffParser_, tiff_parser_, Tiff__init_):
...
class Describe_TiffParser(object):
    def it_can_parse_the_properties_from_a_tiff_stream(self, from_stream_fixture):
        (
            stream_,
    ...
    def _make_stream_reader_(self, request, stream_rdr_):
        return method_mock(
            request, _TiffParser, "_make_stream_reader", return_value=stream_rdr_
        )
...
class Describe_IfdEntry(object):
    ...
    @pytest.fixture
    def from_stream_fixture(self, _parse_value_, _IfdEntry__init_, value_):
    ...
    def _parse_value_(self, request, value_):
        return method_mock(request, _IfdEntry, "_parse_value", return_value=value_)
