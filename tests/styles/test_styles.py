...
class DescribeStyles(object):
    ...
    def it_gets_a_style_id_from_a_name_to_help(self, id_name_fixture):
        ...
        styles._get_style_id_from_style.assert_called_once_with(style_, style_type)
        assert style_id is style_id_
    ...
    def get_by_id_fixture(self, request, default_, _get_by_id_, style_):
        ...
        _get_by_id_calls = [] if style_id is None else [call(style_id, style_type)]
        default_.return_value = _get_by_id_.return_value = style_
        return (styles, style_id, style_type, default_calls, _get_by_id_calls, style_)

    @pytest.fixture(params=[None, BaseStyle(None), "Style Name"])
    def get_style_id_fixture(
        self, request, _get_style_id_from_style_, _get_style_id_from_name_
    ):
        ...
        name_calls = (
            [call(style_or_name, style_type)] if style_or_name == "Style Name" else []
        )
        ...
        return (styles, style_or_name, style_type, style_calls, name_calls, style_id_)
